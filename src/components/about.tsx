...
export function About() {
    return (
        <section id="about" className="py-8 px-4 md:py-16 lg:py-20">
            {/* mobile: coluna; tablet/desktop: 2 colunas */}
            <div className="grid gap-6 md:grid-cols-2 md:gap-8 items-center">
                <motion.div {...fadeUp(0)}>
                    <h2 className="text-2xl text-center md:text-2xl lg:text-3xl font-semibold text-primary">Sobre o CultivoTrace</h2>
                ...
                <motion.div
                    {...fadeUp(0.2)}
                    className="aspect-16/10 md:aspect-video rounded-2xl bg-[url('/about.jpg')] bg-cover bg-center shadow-soft"
                />
            </div>
        </section>
    )
