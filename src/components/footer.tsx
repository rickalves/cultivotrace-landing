...
export function Footer() {
  return (
    <motion.footer {...fadeUp(0)} className="border-t mt-12 md:mt-0  bg-[#02190B] text-white">
      <div className="py-8 text-sm flex flex-col items-center justify-between gap-3 md:py-8 md:px-8 md:text-sm md:flex-row">
